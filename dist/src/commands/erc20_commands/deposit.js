...
const handler = async (args) => {
    ...
    // connect to rollups,
    const { dapp, inputContract, erc20Portal, deployment } = await (0, rollups_2.rollups)(network.chainId, signer || provider, args);
    // connect to provider, use deployment address based on returned chain id of provider
    const erc20Address = erc20 !== null && erc20 !== void 0 ? erc20 : (_a = deployment === null || deployment === void 0 ? void 0 : deployment.contracts["SimpleERC20"]) === null || _a === void 0 ? void 0 : _a.address;
    if (!erc20Address) {
    ...
    const tx = await erc20Portal.depositERC20Tokens(erc20Address, dapp, erc20Amount, "0x");
